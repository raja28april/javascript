...
// Base 10 - 0 to 9. 1/10 = 0.1; 3/10 = 0.3333333333
//Binary base 2 - 0 1
console.log(0.1 + 0.2);
...
//Parsing
console.log(Number.parseInt('30px'));//starting with number so it ignores the letters px
console.log(Number.parseInt('e23'));//starting with letter and hences returns NaN
...
console.log(`Floor +23.3: ${Math.floor(23.3)}`);//23
console.log(`Floor +23.9: ${Math.floor(23.9)}`);//23

console.log(`trunc +23.3: ${Math.trunc(23.3)}`);//23

console.log(`trunc -23.3: ${Math.trunc(-23.3)}`);//-23
console.log(`Floor -23.3: ${Math.floor(-23.3)}`);//-24
